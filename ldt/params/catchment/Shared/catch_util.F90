  ...
  contains
    ...
    subroutine init_geos2lis_mapping 
      ...
      integer                          :: i, j, n, r, c, status, ncid, dx_esa, dy_esa, NBINS, &
           NPLUS, nc_global,nr_global,msk2rst, catNo,ix1,ix2,iy1,iy2, ii, jj, catCount,ncells
      ...
      ! (2) rst/til arrays for GEOS5
      ! ----------------------------
      
      status    = NF_OPEN ('/discover/nobackup/rreichle/l_data/LandBCs_files_for_mkCatchParam/V001/GEOS5_10arcsec_mask.nc', NF_NOWRITE, ncid)
      if(status /=0) then
