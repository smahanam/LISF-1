...
module rmTinyCatchParaMod
  ...
  character*128, parameter :: MaskFile = 'GEOS5_10arcsec_mask.nc'
...
!----------------------------------------------------------------------
  ...
  SUBROUTINE modis_scale_para (ease_grid,gfile)
    ...
    real, allocatable, dimension (:) :: &
         ...
         green,lai,sunang,lai_before,lai_after,grn_before,grn_after
    real, allocatable, dimension (:) :: &
...
! *********************************************************************
      ...
      REAL, INTENT(IN), DIMENSION(NCH)    :: VLAI, VGRN
      REAL, INTENT(IN)                    :: ZTH
...
! ALIDFS:  Albedo of soil for infra-red diffuse solar radiation.
      ...
      REAL, PARAMETER :: DLAI = 0.5, ZERO=0., ONE=1.0
...
! -----------------------------------------------------------------------------------
   ...
   REAL FUNCTION COEFFSIB(TABLE, NTABL, LAI ,DX, DY)
