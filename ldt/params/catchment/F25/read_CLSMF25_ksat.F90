...
!BOP
!
! !ROUTINE: read_CLSMF25_ksat
!  \label{read_CLSMF25_ksat}

! !REVISION HISTORY:
!  25 Nov 2012: K. Arsenault; Initial Specification
!
! !INTERFACE:
subroutine read_CLSMF25_ksat(n,array,maskarray) 
...
!   index of the nest
!  \item[array]
!   output field for saturated hydraulic conductivity (Ksat)
!  \item[maskarray]
...
end subroutine read_CLSMF25_ksat
