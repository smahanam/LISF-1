...
!BOP
!
! !ROUTINE: read_CLSMF25_psisat
!  \label{read_CLSMF25_psisat}

! !REVISION HISTORY:
!  25 Nov 2012: K. Arsenault; Initial Specification
!
! !INTERFACE:
subroutine read_CLSMF25_psisat(n,array,maskarray) 
...
!   index of the nest
!  \item[array]
!   output field for Clapp-Hornberger soil parameter
!  \item[maskarray]
...
end subroutine read_CLSMF25_psisat
