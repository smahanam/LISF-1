...
!BOP
!
! !ROUTINE: read_CLSMF25_bexp
!  \label{read_CLSMF25_bexp}

! !REVISION HISTORY:
!  25 Nov 2012: K. Arsenault; Initial Specification
!
! !INTERFACE:
subroutine read_CLSMF25_bexp(n,array,maskarray) 
...
!   index of the nest
!  \item[array]
!   output field for Clapp-Hornberger B-parameter
!  \item[maskarray]
...
end subroutine read_CLSMF25_bexp
